  ...
  <div class="navbar">
    ...
    <div class="navbar-right-container" style="display: flex;">
      <div class="navbar-menu-container">
        ...
        <a href="javascript:void(0)" class="navbar-link" @click="loginFlag=true" v-show="!nickName">登录</a>
        <a href="javascript:void(0)" class="navbar-link" v-show="nickName">{{nickName}}</a>
        <a href="javascript:void(0)" class="navbar-link" v-show="nickName" @click="loginout">登出</a>
   ...
   <div class="md-modal modal-msg md-modal-transition" :class="{'md-show':this.loginFlag}">
        ...
        <div class="md-overlay" v-show="loginFlag" @click="loginFlag=false">
        </div> 
</header>
</template>
<script>
